...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    final profile = MockData.currentStudent.value;
    _nameController = TextEditingController(text: profile.name);
    _dobController = TextEditingController(text: profile.dob);
    _parentController = TextEditingController(text: profile.parentName);
  }
  ...
  void _saveProfile() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocale.t("Profile updated successfully", widget.lang)),
              ...
              Wrap(
                ...
                children: avatarIcons.entries.map((entry) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      ApiService.updateProfile(StudentProfile(
                        email: profile.email,
                        name: _nameController.text,
                        dob: _dobController.text,
                        parentName: _parentController.text,
