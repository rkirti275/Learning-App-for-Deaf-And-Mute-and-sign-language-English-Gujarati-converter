        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                setState(() {
                  MockData.allStudents.add(
                    StudentProfile(
                      email: "${nameController.text.replaceAll(' ', '').toLowerCase()}@email.com",
                      name: nameController.text.isNotEmpty ? nameController.text : "New Student",
                      dob: dobController.text.isNotEmpty ? dobController.text : "01/01/2010",
                      parentName: parentController.text.isNotEmpty ? parentController.text : "Unknown",
                      presentDays: 0,
                      totalDays: 200,
                      detailedMarks: {},
                    )
